package des.wangku.operate.standard.composite;
...
public class ImageViewer extends Canvas {
	...
	void convertImageDatasToImages() {
		...
		for (int i = 0; i < imageDatas.length; i++) {
			...
			if (i == 0 && transition == SWT.DM_FILL_PREVIOUS) transition = SWT.DM_FILL_NONE;
		}
	}
	...
	void stopAnimationTimer() {
		if (animationTimer != null) display.timerExec(-1, animationTimer);
	}
}
